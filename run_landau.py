...
for Nt in steps:
    ...
    for res in resolutions:
        ...
        loader1_params['vel'] = particle_vel_maxwellian(loader1_params['pos'],v,v_th)
        ...
        sim_name = 'landau_' + prefix + '_' + analysis_params['particleIntegrator'] + '_NZ' + str(res) + '_NQ' + str(nq) + '_NT' + str(Nt) 
        ...
        pData_list = DH.load_p(['pos','vel','KE_sum'],species=['none'],sim_name=sim_name)
        ...
        #fig4 = plt.figure(DH.figureNo+8,dpi=75)
        #hist_ax = fig4.add_subplot(1,1,1)
        #hist_ax.hist(v1_data[0,:],40)
        if plot == True:
            ...
            pert_ax.set_title('Landau damping perturbation, Nt=' + str(Nt) +', Nz=' + str(res+1))
            pert_ax.legend()
            
            ## Phase animation setup
            fig = plt.figure(DH.figureNo+4,dpi=150)
            p_ax = fig.add_subplot(1,1,1)
            line_p1 = p_ax.plot(p1_data[0,0:1],v1_data[0,0:1],'bo',label='Hot, v=0')[0]
