...
for res in resolutions:
    for Nt in steps:
        for K in iterations:
            ...
            sim_name = 'tsi_' + prefix + '_' + analysis_params['particleIntegrator'] + '_M' + str(M) + 'K' + str(K) +  '_NZ' + str(res) + '_NQ' + str(nq) + '_NT' + str(Nt) 
            ...
            mData_dict = DH.load_m(['phi','E','rho','PE_sum','gather_count'],sim_name=sim_name)
            ...
            if plot == True:
                ...
                pert_ax.set_title('Two stream instability perturbation, dt=' + str(dt) + ', Nt=' + str(Nt) +', Nz=' + str(res+1))
                pert_ax.legend()
