...
case_params['ylimits'] = [-15,15] #More dense cells
case_params['zlimits'] = [-15,15]
case_params['resolution'] = [5]
...
data_params['domain_limits'] = [[-15,15],[-15,15],[-15,15]]
...
for key, value in schemes.items():
    ...
    for K in iterations:
        ...
        for i in range(0,len(dt)):
            ...
            data = kppsObject.run()
            Edata = data.mesh_E[1][0,:,:,:]
            qdata = data.mesh_q[1]
            phiData = data.mesh_phi[1]
