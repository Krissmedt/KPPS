...
if analyse == True:
    ...
    for key, value in sims.items():
        ...
        for tsteps in value:
            ...
            iters.append(mData_dict['gmres_iters'][-1])
            dts.append(sim.dt)
...
#                el2_ax.plot(tArray[NA:NB],lit_line,'orange',label="Literature $\gamma$")
        ...
        grp.create_dataset('iters',data=iters)
...
if plot == True:
    ...
    if compare_reference == True:
        ...
        for ax in axnl_list:
            ...
            if i == 1:
                orderSlope = -1
                ax.set_xlabel('Solver iteration total')
            else:
