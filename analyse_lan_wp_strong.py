...
if analyse == True:
    if compare_reference == True:
        ...
        mData_comp = DH_comp.load_m(['phi','rho','E','dz','q','vel_dist','grid_x','grid_v','f','Rx','Rv'],sim_name=comp_sim_name,max_t=analysis_times[-1])
...
#                    skip_int = np.int(skip)
                ...
                if fieldPlot == True:
                    ...
                    E_text1 = E_ax.text(.01,0.02,'',transform=E_ax.transAxes,verticalalignment='bottom',fontsize=16)
                    ...
                    try:
                        ...
                        pass
                    fig.savefig(data_root + 'landau_strong_field.pdf', dpi=150, facecolor='w', edgecolor='w',orientation='portrait',pad_inches=0.05,bbox_inches = 'tight')
    ...
    #                    f_ax.set_title('Landau density distribution, Nt=' + str(Nt) +', Nz=' + str(res+1))
                ...
                if resPlot == True:
                    ...
                    R_ax.set_yscale('log')
                    R_ax.legend()
                    fig_R.savefig(data_root + 'lan_strong_residual.pdf', dpi=150, facecolor='w', edgecolor='w',orientation='portrait',pad_inches=0.05,bbox_inches = 'tight')
