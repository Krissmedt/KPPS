...
peak_intervals = [[0,2],[2,4],[4,6],[6,8],[8,11]]
...
sims['lan_TE50_K0.5_boris_staggered_NZ256_NQ163000_NT'] = [500]

comp_run = 'lan_TE50_K0.5_boris_staggered_NZ256_NQ163000_NT500'
...
if analyse == True:
    ...
    for key, value in sims.items():
        ...
        filename = key[:-3] + "_wp_"  + str(compare_time)+ "s"  ".h5"
        ...
        try:
            for tsteps in value:
                ...
                error_linear2 = abs(gamma_lit2 - E_fit2[0])/abs(gamma_lit2)
...
#                    E_ax.plot(tArray[NC:ND],gamma_line,'red',label="$Analyt$")
                    ...
                    E_text2 = E_ax.text(.5,0,'',transform=E_ax.transAxes,verticalalignment='bottom',fontsize=14)
                    ...
                    E_ax.set_title('Non-linear Landau damping, a=0.5, NQ=' + str(nq) + ', NZ=' + str(mData_dict['zres'][0]) 
                                    + ', NT=' + str(sim.tSteps)) 
                    E_ax.legend()
