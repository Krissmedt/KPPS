...
from kpps.collocation.gauss_legendre import CollGaussLegendre
from kpps.collocation.gauss_lobatto import CollGaussLobatto
...
class Simulator:
    ...
    def collSetup(self, species_list, fields, controller=None, **kwargs):
        ...
        coll = self.collocationClass(self.M, 0,
                                     1)  # Initialise collocation/quadrature analysis object (class is Daniels old code)
    ...
    def analytical_penning(self, t, omegaE, omegaB, H, x0, v0, epsilon=-1):
        ...
        x = Rplus * cos(omegaPlus * t) + Rminus * cos(omegaMinus * t) + Iplus * sin(omegaPlus * t) + Iminus * sin(
            omegaMinus * t)
        y = Iplus * cos(omegaPlus * t) + Iminus * cos(omegaMinus * t) - Rplus * sin(omegaPlus * t) - Rminus * sin(
            omegaMinus * t)
        z = x0[0, 2] * cos(omegaTilde * t) + v0[0, 2] / omegaTilde * sin(omegaTilde * t)

        vx = Rplus * -omegaPlus * sin(omegaPlus * t) + Rminus * -omegaMinus * sin(
            omegaMinus * t) + Iplus * omegaPlus * cos(omegaPlus * t) + Iminus * omegaMinus * cos(omegaMinus * t)
        vy = Iplus * -omegaPlus * sin(omegaPlus * t) + Iminus * -omegaMinus * sin(
            omegaMinus * t) - Rplus * omegaPlus * cos(omegaPlus * t) - Rminus * omegaMinus * cos(omegaMinus * t)
