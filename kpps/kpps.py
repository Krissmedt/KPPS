...
import io
import pickle as pk
from kpps.model.species import Species as species_class
from kpps.model.mesh import Mesh
from kpps.initialisation.particle_loader import ParticleLoader as pLoader_class
...
class Kpps:
    ...
    def restart(self, folder, sim_name, tstep, **kwargs):
        ...
        analyser = Simulator(simulationManager=sim,
