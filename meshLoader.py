...
class meshLoader:
    def __init__(self,**kwargs):
        ...
        for species in self.species_list:
            if self.particle_init == 'none':
                ...
                self.custom_case(species)
    
            self.set_particle_inputs(species)
    ...
    def set_particle_inputs(self,species):
        if self.ndim == 2:
            try:
                species.pos[:,0] = self.xlimits[0] + (self.xlimits[1]-self.xlimits[0])/2.
                species.vel[:,0] = 0
            ...
            try:
                species.pos[:,0] = self.xlimits[0] + (self.xlimits[1]-self.xlimits[0])/2.
                species.pos[:,1] = self.ylimits[0] + (self.ylimits[1]-self.ylimits[0])/2.
                species.vel[:,0] = 0
                species.vel[:,1] = 0
